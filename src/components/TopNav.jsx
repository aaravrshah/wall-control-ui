  ...
  return (
    <header className="top-nav">
      <div className="brand-block">
        ...
        <p className="brand-copy">4 x 16 actuator sketch generation for smooth Arduino-owned motion</p>
      </div>
      <nav>
        {links.map((link) => (
      ...
      <div className="nav-status">
        ...
        <span className="status-pill stable">Manual Arduino Upload</span>
      </div>
    </header>
  );
}
